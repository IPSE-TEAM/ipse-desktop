    ...
    },
    {
      ...
      submenu: [
        ...
        },
        {
          ...
          click: () => { shell.openExternal('https://github.com/IPSE-TEAM/ipse-desktop/releases') }
        },
        {
        ...
        },
        {
          ...
          click: () => { shell.openExternal('https://github.com/IPSE-TEAM/ipse-desktop/blob/master/README.md') }
        }
      ]
    },
    {
